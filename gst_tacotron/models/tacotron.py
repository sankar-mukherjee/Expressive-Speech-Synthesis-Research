...
class Tacotron():
    ...
    '''
        with tf.variable_scope('inference') as scope:
            ...
            # 2nd ref
            # Reference encoder
            refnet_outputs2 = reference_encoder(
                mel_outputs,
                filters=hp.reference_filters,
                kernel_size=(3, 3),
                strides=(2, 2),
                ...
                is_training=is_training,
                re_use=True)  # [N, 128]
            self.refnet_outputs2 = refnet_outputs2
    ...
    def add_loss(self):
        ...
        with tf.variable_scope('loss') as scope:
            ...
            # style token loss
            self.ref_enc_loss = tf.reduce_mean(tf.abs(self.refnet_outputs - self.refnet_outputs2))
            self.loss = self.mel_loss + self.linear_loss + self.ref_enc_loss
